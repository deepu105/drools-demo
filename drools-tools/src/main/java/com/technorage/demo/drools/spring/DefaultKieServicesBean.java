...
public class DefaultKieServicesBean implements KieServicesBean {
	...
	public KieBaseConfiguration newKieBaseConfiguration(Properties properties,
		...
		return kieServices.newKieBaseConfiguration(properties, classLoader);
	}
	...
	public KieSessionConfiguration newKieSessionConfiguration(
		...
		return kieServices.newKieSessionConfiguration(properties);
	}

	@Override
	public Environment newEnvironment() {
		return kieServices.newEnvironment();
	}

	@Override
	public KieContainer getKieClasspathContainer(ClassLoader arg0) {
		return kieServices.getKieClasspathContainer(arg0);
	}

	@Override
	public KieBaseConfiguration newKieBaseConfiguration(Properties arg0) {
		return kieServices.newKieBaseConfiguration(arg0);
	}

	@Override
	public KieContainer newKieClasspathContainer(ClassLoader arg0) {
		return kieServices.newKieClasspathContainer(arg0);
	}
